...
if __name__ == "__main__":
    ...
    parser.add_argument("--anti_spoofing_hef", type=str, default="/home/kevinvgu/Access-Control-System-main/models/mobilenet_v3.hef", help="Đường dẫn đến model Anti-Spoofing NPU")
